package fr.teama.robothardwaremockservice.helpers;
...
public class LoggerHelper {
    ...
    private static final String SERVICE_NAME = "robot-hardware-mock-service";

    private static final String SERVICE_COLOR = "\u001B[93m";
