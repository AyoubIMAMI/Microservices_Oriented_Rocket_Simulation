package fr.teama.payloadhardwaremockservice.helpers;
...
public class LoggerHelper {
    ...
    private static final String SERVICE_NAME = "payload-hardware-mock-service";
    private static final String SERVICE_COLOR = "\u001B[37m";
