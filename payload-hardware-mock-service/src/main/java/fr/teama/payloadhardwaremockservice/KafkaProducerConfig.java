...
{
    @Bean
    public ProducerFactory<String, PayloadData> producerPayloadDataFactory()
    {
    ...
    @Bean
    public KafkaTemplate<String, PayloadData> kafkaPayloadDataTemplate()
    {
        return new KafkaTemplate<>(producerPayloadDataFactory());
    }
}
