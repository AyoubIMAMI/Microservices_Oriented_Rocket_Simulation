...
import fr.teama.telemetryservice.controllers.dto.TrackItemDTO;
...
public class TrackItem {
    ...
    public TrackItem(TrackItemDTO trackItemDTO) {
        this.data = trackItemDTO.getData();
        this.fieldToTrack = trackItemDTO.getFieldToTrack();
        this.operationType = trackItemDTO.getOperationType();
    }
