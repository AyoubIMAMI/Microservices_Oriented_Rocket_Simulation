...
public class StageHardwareProxy implements IStageHardwareProxy {
    ...
    @Override
    public void startLogging(StageData stageToDetach, Double altitude, Double speed) throws StageHardwareServiceUnavailableException {
        StageFullStateDTO stageFullStateDTO = new StageFullStateDTO(stageToDetach, altitude, speed);
