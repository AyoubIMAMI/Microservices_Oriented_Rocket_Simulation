...
{
    @Bean
    public ProducerFactory<String, RocketData> producerRocketDataFactory()
    {
    ...
    @Bean
    public KafkaTemplate<String, RocketData> kafkaRocketDataTemplate()
    {
        return new KafkaTemplate<>(producerRocketDataFactory());
    }
}
