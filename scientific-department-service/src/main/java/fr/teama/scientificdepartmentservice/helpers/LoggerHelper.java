package fr.teama.scientificdepartmentservice.helpers;

import fr.teama.scientificdepartmentservice.connectors.LogsProxy;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class LoggerHelper {
    private static final Logger LOGGER = LoggerFactory.getLogger(LoggerHelper.class);
    private static final String SERVICE_NAME = "rocket-department-service";
    private static final String SERVICE_COLOR = "\u001B[35m";
